			...
			<div class="col product_section clearfix">
				...
				<div class="breadcrumbs d-flex flex-row align-items-center">
					<ul>
						...
						<li class="active"><a href="<?=base_url()?>on_panel/home/kategoriler/<?=$veri[0]->kategori_ad?>"><i class="fa fa-angle-right" aria-hidden="true"></i><?=$veri[0]->kategori_ad?></a></li>
					</ul>
				</div>

	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<?=base_url()?>assets/on_panel/images/bg-01.jpg');">
			<div class="wrap-login100">
				<form method="POST" action="<?=base_url()?>on_panel/login/login_islemi" class="login100-form validate-form">
				...
				<?php if ($this->session->flashdata("sonuc")) { ?>
					<i class="fa fa-check" aria-hidden="true"></i><span style="margin-top: 20px" class="text-center p-t-90"> <?=$this->session->flashdata("sonuc") ?></span>
				<?php  }  ?>
				
				<div class="text-center p-t-90">
					<a class="txt1" href="<?=base_url()?>on_panel/login/register">
						Hesap Oluştur <i class="fa fa-arrow-circle-right" aria-hidden="true"></i>
					</a>
				</div>

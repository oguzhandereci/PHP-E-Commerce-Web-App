            ...
            <div class="clearfix"></div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Ürün Listesi</h2>
                    <a href="<?=base_url()?>admin_panel/urunler/urun_ekle/elektronik" class="btn btn-info pull-right" role="button"><i style="font-size: 20px" class="fa fa-plus-circle" aria-hidden="true"></i>Ürün Ekle</a>
                    <div class="clearfix"></div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title"><span>Ürün ID</span> </th>
                          ...
                          <tbody>
                            <tr class="even pointer">
                              ...
                              <td class=" ">
                                ...
                                <a href="<?=base_url()?>admin_panel/urunler/resim_ekle/elektronik/<?=$rs->urun_id?>"><img src="<?=base_url()?>temp/<?=$rs->urun_resim?>" width="30" height="30"></a>
                              <?php }  
                                    else{ ?>
                                      <a href="<?=base_url()?>admin_panel/urunler/resim_ekle/elektronik/<?=$rs->urun_id?>"><i class="fa fa-plus-circle" style="font-size: 25px" aria-hidden="true"></i></a>
                              <?php      }  ?>
                              </td>
                              ...
                              <td class=" "><a href="<?=base_url()?>admin_panel/urunler/galeri/<?=$rs->urun_id?>"> 
                                <i class="fa fa-sign-in" style="font-size: 25px;margin-left: 25px" title="Galeriye Git" aria-hidden="true"></i></a>
                              </td>
                              <td class=" ">
                                ...
                                <a onclick="confirm('Silmek istediğinizden emin misiniz?')" href="<?=base_url()?>admin_panel/urunler/urun_sil/elektronik/<?=$rs->urun_id?>"><i class="fa fa-trash" style="font-size: 25px;margin-left: 10px" aria-hidden="true"></i></a>
                              </td>
                            </tr>

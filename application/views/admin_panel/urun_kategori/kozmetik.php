            ...
            <div class="clearfix"></div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Ürün Listesi</h2>
                    <a href="<?=base_url()?>admin_panel/urunler/urun_ekle/kozmetik" class="btn btn-info pull-right" role="button"><i style="font-size: 20px" class="fa fa-plus-circle" aria-hidden="true"></i> Ürün Ekle</a>
                          ...
                          <tbody>
                            <tr class="even pointer">
                              ...
                              <td class=" ">
                                ...
                                <a href="<?=base_url()?>admin_panel/urunler/resim_ekle/kozmetik/<?=$rs->urun_id?>"><img src="<?=base_url()?>temp/<?=$rs->urun_resim?>" width="30" height="30"></a>
                              <?php }  
                                    else{ ?>
                                      <a href="<?=base_url()?>admin_panel/urunler/resim_ekle/kozmetik/<?=$rs->urun_id?>"><i class="fa fa-plus-circle" style="font-size: 25px" aria-hidden="true"></i></a>
                              <?php      }  ?>
                              </td>
                              ...
                              <a href="<?=base_url()?>admin_panel/urunler/urun_galeri/<?=$rs->urun_id?>"><i class="fa fa-plus-circle" style="font-size: 25px" aria-hidden="true"></i></a></td>
                              <td class=" ">
